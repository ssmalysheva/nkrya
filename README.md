...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: в некоторых документах слово может встречаться несколько раз 
```
### 2. IPM
...
ipm = 126/283 431 966 * 1.000.000 = 0,44
```
# 2.1 Значение IPM:
0,44
